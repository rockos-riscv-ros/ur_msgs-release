...
The packages in the `ur_msgs` repository were released into the `jazzy` distro by running `/home/z572/gits/rockos-ros/venv/bin/bloom-release -r jazzy ur_msgs --override-release-repository-push-url git@github.com:rockos-riscv-ros/ur_msgs-release` on `Fri, 21 Mar 2025 07:58:48 -0000`
...
- release repository: https://github.com/rockos-riscv-ros/ur_msgs-release.git
